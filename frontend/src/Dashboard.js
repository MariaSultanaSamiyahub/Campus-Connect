...
// Add this as a new page component matching your group's style
...
export default function Dashboard() {
  ...
  const userRole = localStorage.getItem('userRole') || 'student'; // Get from your auth
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      const activityRes = await fetch(`${API_BASE}/dashboard/recent-activity`, {
        headers: getAuthHeaders()
      });
      if (activityRes.ok) {
    ...
    <div style={styles.container}>
      ...
      <nav style={styles.navbar}>
        <div style={styles.navContent}>
          <h1 style={styles.navBrand}>🎓 Campus Connect - Dashboard</h1>
          <div style={styles.navButtons}>
            <button 
              onClick={() => setCurrentTab('dashboard')} 
              style={{
                ...styles.navButton, 
                ...(currentTab === 'dashboard' ? styles.navButtonActive : styles.navButtonInactive)
              }}
            >
            ...
            <button 
              ...
              style={{
                ...styles.navButton, 
                ...(currentTab === 'notifications' ? styles.navButtonActive : styles.navButtonInactive)
              }}
            >
            ...
            {isAdmin && (
              <button 
                ...
                style={{
                  ...styles.navButton, 
                  ...(currentTab === 'moderation' ? styles.navButtonActive : styles.navButtonInactive)
                }}
              >
